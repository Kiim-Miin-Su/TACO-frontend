...
import { jsonPreferenceCodec, readPreference, writePreference, type PreferenceCodec } from "@/lib/storage/preferences";
...
export function usePersistedState<T>(
  ...
  useEffect(() => {
    setValue(readPreference(key, initial, codecRef.current));
    loaded.current = true;
